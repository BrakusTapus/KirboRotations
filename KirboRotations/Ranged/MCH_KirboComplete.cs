...
public class MCH_KirboComplete : MCH_Base
{
	...
	public override void DisplayStatus()
	{
		...
		if(!Methods.InPvP())
		{
			ImGui.Text("Rotation Selection: " + Configs.GetCombo("RotationSelection"));
	...
	protected override bool GeneralGCD(out IAction act)
	{
		...
		if(PvP_Scattergun.CanUse(out act, CanUseOption.MustUseEmpty, 1) && HostileTarget.DistanceToPlayer() < 12 && !IsPvPOverheated) return true;
	...
	protected override bool EmergencyAbility(IAction nextGCD, out IAction act)
	{
		...
		if(PvP_BishopAutoTurret.CanUse(out act, CanUseOption.MustUse) && HasHostilesInRange) return true;
		#endregion
