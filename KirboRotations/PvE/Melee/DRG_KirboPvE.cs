...
internal sealed class DRG_KirboPvE : DRG_Base
{
    ...
    protected override bool AttackAbility(out IAction act)
    {
        if (IsBurst)
        {
            if (LanceCharge.CanUse(out act, CanUseOption.MustUse) && Player.HasStatus(true, StatusID.PowerSurge))
            {
                return true;
            }

            if (LanceCharge.CanUse(out act, CanUseOption.MustUse | CanUseOption.OnLastAbility) && !Player.HasStatus(true, StatusID.PowerSurge))
            {
                return true;
            }

            if (DragonSight.CanUse(out act, CanUseOption.MustUse))
            {
                return true;
            }

            if (BattleLitany.CanUse(out act, CanUseOption.MustUse))
            {
                return true;
            }
        }

        if (Nastrond.CanUse(out act, CanUseOption.MustUse))
        {
            return true;
        }

        if (StarDiver.CanUse(out act, CanUseOption.MustUse))
        {
            return true;
        }
        ...
        {
            if (Player.HasStatus(true, StatusID.LanceCharge) && LanceCharge.ElapsedOneChargeAfterGCD(3))
            {
                return true;
            }
        }
        if (Player.HasStatus(true, StatusID.PowerSurge) && SpineShatterDive.CurrentCharges != 1 && SpineShatterDive.CanUse(out act))
        {
            return true;
        }

        if (MirageDive.CanUse(out act))
        {
            return true;
        }
    ...
    protected override bool GeneralGCD(out IAction act)
    {
        ...
        if (SonicThrust.CanUse(out act))
        {
            return true;
        }

        if (DoomSpike.CanUse(out act))
        {
            return true;
        }

        if (WheelingThrust.CanUse(out act))
        {
            return true;
        }

        if (FangandClaw.CanUse(out act))
        {
            return true;
        }

        if (FullThrust.CanUse(out act))
        {
            return true;
        }

        if (ChaosThrust.CanUse(out act))
        {
            return true;
        }
        ...
        {
            if (Disembowel.CanUse(out act))
            {
                return true;
            }
        }

        if (VorpalThrust.CanUse(out act))
        {
            return true;
        }

        if (TrueThrust.CanUse(out act))
        {
            return true;
        }
        ...
        if (PiercingTalon.CanUse(out act))
        {
            return true;
        }
