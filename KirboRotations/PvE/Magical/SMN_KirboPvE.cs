...
internal sealed class SMN_KirboPvE : SMN_Base
{
    ...
    protected override bool AttackAbility(out IAction act)
    {
        ...
        {
            //灼热之光
            if (SearingLight.CanUse(out act))
            {
                return true;
            }
        }
        ...
        //龙神不死鸟迸发
        if ((InBahamut && SummonBahamut.ElapsedOneChargeAfterGCD(3) || InPhoenix || IsTargetBoss && IsTargetDying) && EnkindleBahamut.CanUse(out act, CanUseOption.MustUse))
        {
            return true;
        }
        ...
        //能量抽取
        if (EnergySiphon.CanUse(out act))
        {
            return true;
        }
    ...
    protected override bool EmergencyAbility(IAction nextGCD, out IAction act)
    {
        ...
        switch (Configs.GetCombo("addSwiftcast"))
        {
            ...
            case 1:
                ...
                {
                    if (Swiftcast.CanUse(out act, CanUseOption.MustUse))
                    {
                        return true;
                    }
                }
